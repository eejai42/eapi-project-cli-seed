...
namespace YP.SassyMQ.Lib.RabbitMQ
{
    public partial class SMQAdmin : SMQActorBase
    {
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.addglobalsetting", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.getglobalsettings", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.updateglobalsetting", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.deleteglobalsetting", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.addscore", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.getscores", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.updatescore", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.deletescore", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.addailevel", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.getailevels", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.updateailevel", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.deleteailevel", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.adduielement", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.getuielements", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.updateuielement", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.deleteuielement", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.addtranslation", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.gettranslations", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.updatetranslation", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.deletetranslation", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.addlanguagetoken", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.getlanguagetokens", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.updatelanguagetoken", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.deletelanguagetoken", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.addadditionalresource", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.getadditionalresources", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.updateadditionalresource", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.deleteadditionalresource", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.addgame", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.getgames", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.updategame", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.deletegame", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.addcell", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.getcells", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.updatecell", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.deletecell", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.addcellpattern", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.getcellpatterns", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.updatecellpattern", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.deletecellpattern", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.adduser", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.getusers", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.updateuser", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.deleteuser", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.addcellpatterncell", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.getcellpatterncells", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.updatecellpatterncell", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.deletecellpatterncell", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.addtargetplatform", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.gettargetplatforms", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.updatetargetplatform", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.deletetargetplatform", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.addaistrategy", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.getaistrategies", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.updateaistrategy", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.deleteaistrategy", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.addcellstate", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.getcellstates", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.updatecellstate", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.deletecellstate", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.addcellpatterntranslation", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.getcellpatterntranslations", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.updatecellpatterntranslation", payload, replyHandler, timeoutHandler, waitTimeout);
        }
        ...
        {
            return this.SendMessage("crudcoordinator.crud.admin.deletecellpatterntranslation", payload, replyHandler, timeoutHandler, waitTimeout);
        }
