...
{
    public partial class GamingCoordinatorCLIHandler
    {
        private string HandlerFactory(string invokeRequest, string payloadString)
        {
            ...
            {
                case "gamingstarting":
                    this.SMQActor.GamingStarting(payload, (reply, bdea) =>
                    {
                ...
                case "gamingchanged":
                    this.SMQActor.GamingChanged(payload, (reply, bdea) =>
                    {
                        result = SerializePayload(reply);
                    }).Wait(30000);
                    break;                   
                ...
                case "gameupdated":
                    this.SMQActor.GameUpdated(payload, (reply, bdea) =>
                    {
                        result = SerializePayload(reply);
                    }).Wait(30000);
                    break;                   
